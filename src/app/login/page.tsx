    ...
    <div className="min-h-screen flex">
      <div className="w-full lg:w-1/2 bg-[#111111] flex flex-col justify-center px-10 py-16 md:px-16 lg:px-20 xl:px-28">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full bg-[#1a1a1a] border rounded-xl pl-11 pr-4 py-3.5 text-sm text-white placeholder:text-neutral-600 focus:outline-none focus:bg-[#1f1f1f] transition-all ${
                  errors.email 
        ...
        <p className="text-sm text-neutral-500 mt-8 text-center">
          ...
          <Link href="/signup" className="text-white font-semibold hover:text-neutral-300 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
